                                                  ...
                                                  <thead class="table-light">
                                                    ...
                                                    <tbody class="list form-check-all">
                                                        ...
                                                        <tr >
                                                            ...
                                                            <td class="">{{ $dependend->email }}</td>
                                                            <td class="">{{ $dependend->phone }}</td>
                                                            <td class="">{{ $dependend->sex }}</td>
                                                               <td class="">{{ $dependend->ailments  }}</td>
                                                               <td class="lead_score">{{ $dependend->address  }}</td>
                                                            <td>
                                                                        ...
                                                                        <div class="dropdown">
                                                                            ...
                                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                              ...
                                                                              @foreach ($accounts as $account )
                                                                                    ...
                                                                                    @if ($account->dependend_id==$dependend->id)
                                                                                ...
                                                                                @if ($count==0)
                                                                                        ...
                                                                                        <li>
                                                                                            <form action="/dependendsAccounts/{{ $dependend->id }}/{{ $dependend->member_id }}/store" method="POST">
                                                                                                @csrf
                                                                                ...
                                                                                <li><a class="dropdown-item edit-item-btn" href="/dependends/{{ $dependend->id }}/edit"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</a></li>
                                                                                <li> 
